    ...
    {self.table_name}
        ...
        if condition is not None:
            ...
            if condition.item_ids is not None and len(condition.item_ids) > 0:
                ...
                prefix = "AND"
            if (
                condition.applied_from is not None
                and condition.applied_from_before is not None
                and condition.applied_from_after is not None
            ):
                raise ValueError("cannot use applied_from, applied_from_before, and applied_from_after simultaneously")
            if (
                condition.applied_to is not None
                and condition.applied_to_before is not None
                and condition.applied_to_after is not None
            ):
                raise ValueError("cannot use applied_to, applied_to_before, and applied_to_after simultaneously")
